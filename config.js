...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~rRwxACYI#ihgOeD2WiEeyD1FIC7qln04oOn7It4saVIRyp_9flV0",
    CAPTION: process.env.CAPTION || "POWERED BY PHILOSOPHER",
